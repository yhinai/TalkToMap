...
// FIX: To resolve module augmentation errors, this file must be treated as a module.
// Adding top-level imports and an export statement ensures TypeScript can find the modules to augment.
